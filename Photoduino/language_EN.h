...
const prog_char PROGMEM MSG_SENSOR_TUNNING[] =                    "Sensor Tunning";
const prog_char PROGMEM MSG_SENSOR_TUNNING_VISUAL[] =             "Visual";
const prog_char PROGMEM MSG_SENSOR_TUNNING_NUMERIC[] =            "Numeric";
...
const prog_char PROGMEM MSG_DEVICE_PORT_TYPE[] =                  "Device Port Type";
